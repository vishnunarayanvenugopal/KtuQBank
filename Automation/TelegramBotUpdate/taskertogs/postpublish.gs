function callit()
{
  var title="This is titile";
  var content="This is content";
  var pdflinks=["https://drive.google.com/file/d/1skqkQa2c7ZvUt3TY3J_5sKEu_v1H68ti/preview"];
  var weburllinks=["https://ktuqbank.com/test"];
  var pdflinkforocrarray=["https://bit.ly/3eorZUz"];
  var linktext=["lnk1","lnk2"];
  RUNTHIS(title,content,pdflinks,weburllinks,pdflinkforocrarray,linktext);
}
...
function RUNTHIS(title,content,pdflinks,weburllinks,pdflinkforocrarray,linktext) {
  ...
  function generateinitial(title,content)
  {
    ...
    function ocrpdftext(pdflinkforocrarray)
    {
      ...
      for(var i=0;i<pdflinkforocrarray.length;i++)
      {
       ...
       ocrtext=ocrtext+pdfocr(pdflinkforocrarray[i]);
    ...
    function iframegen(pdflinks)
    {
      ...
      {
        iframe=iframe+"</br><iframe src=\""+pdflinks[i]+"\" width=\"640\" height=\"480\"><\/iframe></br>";
      }
